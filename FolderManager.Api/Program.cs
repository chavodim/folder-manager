...
using FolderManager.Infrastructure;
...
builder.Services.AddScoped<FolderManagerDbContextSeed>();
...
if (app.Environment.IsDevelopment())
{
    ...
    app.Services.CreateScope().ServiceProvider.GetRequiredService<FolderManagerDbContextSeed>().Seed();
}
